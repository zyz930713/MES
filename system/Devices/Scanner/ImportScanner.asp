...
<body>
<form name="form1" enctype="multipart/form-data" method="post" action="/Devices/Scanner/ImportScanner1.asp">
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="2" class="t-c-greenCopy">Import Scanner </td>
  </tr>
  <tr>
    <td width="13%" height="20">Scanner File </td>
