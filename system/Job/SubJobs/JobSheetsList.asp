...
pagepara="&sheetnumber="&sheetnumber&"&jobtype="&jobtype&"&partnumber="&partnumber&"&line="&line&"&factory="&factory&"&jobstatus="&jobstatus&"&currentstation="&currentstation&"&timespan="&timespan&"&ordername="&ordername&"&ordertype="&ordertype
pagename="/Job/JobSheetsList.asp"
FactoryRight "P."
SQL="select 1,J.*,P.PART_NUMBER,P.STATIONS_INDEX as P_STATIONS_INDEX,P.STATIONS_TRANSACTION as P_STATIONS_TRANSACTION from JOB J inner join PART P on J.PART_NUMBER_ID=P.NID where J.JOB_NUMBER not like '%E'"&where&factorywhereoutsideand&order
...
<!--#include virtual="/Language/Job/SubJobs/Lan_JobSheetsList.asp" -->
</head>
...
<form action="/Job/SubJobs/Job.asp" method="get" name="form1" target="_self">
  <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    ...
    <tr>
      <td height="20"><span id="inner_SearchSheetNumber"></span></td>
      <td height="20"><input name="sheetnumber" type="text" id="sheetnumber" value="<%=sheetnumber%>" size="3" maxlength="3"></td><td><span id="inner_SearchJobType"></span></td>
  ...
  <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    ...
    <tr>
      <td height="20" colspan="14" class="t-c-greenCopy"><span id="inner_User"></span>:
      <% =session("User") %></td>
    </tr>
    <tr>
...
%>
    <tr>
      ...
      <td><div align="left"><%=getStationOperator(rs("JOB_NUMBER"),rs("SHEET_NUMBER"),rs("JOB_TYPE"),replace(stations_index,",","','"),repeated_stations_sequence,stations_index," -> ")%>&nbsp;</div></td>
    </tr>
<%
i=i+1
rs.movenext
...
%>
    <tr>
      <td height="20" colspan="14"><div align="center"><span id="inner_Records"></span>No Records</div></td>
    </tr>
<%end if
rs.close%>
	<tr>
      <td height="20" colspan="14"><!--#include virtual="/Components/JobNote.asp" --></td>
    </tr>
</table>
