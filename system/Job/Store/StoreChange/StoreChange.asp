...
pagename="/Reports/Store/StoreChange/StoreChange.asp"
FactoryRight "J."
SQL="select 1,J.* from JOB_MASTER_STORE_CHANGE J inner join FACTORY F on J.FACTORY_ID=F.NID where J.JOB_NUMBER is not null "&where&factorywhereoutsideand&order
session("SQL")=SQL
...
<!--#include virtual="/Language/Reports/Store/StoreChange/Lan_StoreChange.asp" -->
<!--#include virtual="/Language/Components/Lan_PageSplit.asp" -->
</head>

<body onLoad="language();language_page()">
<form name="form1" method="post" action="/Job/Store/StoreChange/StoreChange.asp">
...
<tr>
  ...
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_OldStoreCode"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_OldInputQuantity"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_OldStoreQuantity"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_NewStoreQuantity"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><img src="/Images/Accend.gif" alt="Click to accend records" width="10" height="10" align="absmiddle" style="cursor:hand" onClick="javascript:location.href='<%=pagename%>?ordername=J.STORE_TIME&ordertype=asc&pagenum=<%=firstpage%>&pagesize_a=<%=pagesize_s%><%=pagepara%>'"><span id="inner_OldStoreTime"></span><img src="/Images/Decend.gif" alt="Click to decend records" width="10" height="10" align="absmiddle" style="cursor:hand" onClick="javascript:location.href='<%=pagename%>?ordername=J.STORE_TIME&ordertype=desc&pagenum=<%=firstpage%>&pagesize_a=<%=pagesize_s%><%=pagepara%>'"></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_OldStoreType"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_OldNote"></span></div></td>
  <td height="20" class="t-t-Borrow"><div align="center"><span id="inner_SubJobs"></span></div></td>
</tr>
<%
i=1
if not rs.eof then
...
%>
	<tr>
	  ...
	  <td height="20"><div align="center"><%=rs("OLD_STORE_CODE")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=rs("OLD_INPUT_QUANTITY")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=rs("OLD_STORE_QUANTITY")%></div></td>
	  <td height="20"><div align="center"><%=rs("NEW_STORE_QUANTITY")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=rs("OLD_STORE_TIME")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=rs("OLD_STORE_TYPE")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=rs("OLD_NOTE")%>&nbsp;</div></td>
	  <td height="20"><div align="center"><%=formatlongstring(rs("SUB_JOB_NUMBERS"),"<br>",50)%>&nbsp;</div></td>
  </tr>
<%
i=i+1
rs.movenext
...
%>
  <tr>
    <td height="20" colspan="16"><div align="center"><span id="inner_NoRecords">No Records</span></div></td>
  </tr>
<%end if
rs.close%>
</table>
