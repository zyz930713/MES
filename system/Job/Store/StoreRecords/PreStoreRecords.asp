...
pagename="/Job/Store/StoreRecords/PreStoreRecords.asp"
FactoryRight "J."
SQL="select J.*,JM.ERP_JOB_STATUS,JM.BOM_LABEL from JOB_MASTER_STORE_PRE J inner join JOB_MASTER JM on J.JOB_NUMBER=JM.JOB_NUMBER left join LINE L on J.LINE_NAME=L.LINE_NAME where (J.store_code like '%-0000' or J.job_number IN(select job_number From job_master_scrap where scrap_code like '%0000%'))"&factorywhereoutsideand&where&order
...
<!--#include virtual="/Language/Reports/Store/StoreRecords/Lan_PreStoreRecords.asp" -->
<!--#include virtual="/Language/Components/Lan_PageSplit.asp" -->
</head>

<body onLoad="language();language_page()">
<form name="form1" method="get" action="/Job/Store/StoreRecords/PreStoreRecords.asp">
  ...
  <td height="20" colspan="18" class="t-c-greenCopy"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%" class="t-c-greenCopy"><span id="inner_User"></span>: 
          <% =session("User") %></td>
        <td width="50%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('StoreRecords_Export.asp')"><img src="/Images/EXCEL.gif" width="22" height="22"></span></div></td>
      </tr>
    </table></td>
</tr>
<tr>
...
%>
  <tr>
    <td height="20" colspan="18"><div align="center"><span id="inner_NoRecords"></span></div></td>
  </tr>
<%end if
rs.close%>
</table>
