...
query=replace(query,"&","*")
pagename="/Reports/Store/StoreNoYield/StoreNoYieldbyPartNumber.asp"
SQL=session("SQL")
...
<!--#include virtual="/Language/Reports/Store/StoreNoYield/Lan_StoreNoYieldbyPartNumber.asp" -->
</head>
