...
rs.open SQL,conn,1,3
	...
	sheet.cells(1,1).value="Store Detailed List of "&jobnumber
	...
	sheet.cells(2,5).value="Store Quantity"
	...
	sheet.cells(2,6).value="Store Time"
	...
	sheet.cells(2,7).value="Store Type"
	...
	sheet.cells(2,8).value="Sub Job Numbers"
...
while not rs.eof
	...
	sheet.cells(i,6).value=formatdate(rs("STORE_TIME"),application("longdateformat"))
	sheet.cells(i,7).value=rs("STORE_TYPE")
	sheet.cells(i,8).value=rs("SUB_JOB_NUMBERS")
i=i+1
rs.movenext
wend
