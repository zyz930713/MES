...
pagename="/Job/Scrap/ScrapRecords/ScrapRecords.asp"
FactoryRight "J."
SQL="select J.*,JM.ERP_JOB_STATUS,PF.NID from JOB_MASTER_SCRAP J inner join JOB_MASTER JM on J.JOB_NUMBER=JM.JOB_NUMBER left join PROFILE_FORM PF on J.PROFILE_FORM_ID=PF.NID inner join FACTORY F on J.FACTORY_ID=F.NID where J.JOB_NUMBER is not null and J.SCRAP_QUANTITY<>0 "&where&factorywhereoutsideand&order
'response.Write(SQL)
session("SQL")=SQL
