...
cmd.CommandText="EDIT_SHIFT_JOB"
cmd.CommandType=4
cmd.Parameters.Append cmd.CreateParameter("v_job_id", adNumeric, adParamInput, 10, job_id) 
...
word="Successfully to modify schedule.\n成功修改计划任务！"
else
word="Fail to modify schedule.\n修改计划任务失败！"
end if
%>
