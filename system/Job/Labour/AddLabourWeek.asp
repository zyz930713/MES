...
<form action="/Job/Labour/AddLabourWeek1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
...
<tr>
  ...
  <%=getLine("OPTION_LINE_NAME",""," where LEADER='3125'","","")%>
  </select>    &nbsp;</td>
</tr>
<tr>
  <td height="20"><span id="inner_Year"></span> <span class="red">*</span></td>
  <td height="20" class="red"><input name="year" type="text" id="year" value="<%=year(date())%>" size="4"></td>
</tr>
<tr>
  <td width="82" height="20"><span id="inner_Week"></span> <span class="red">*</span></td>
    <td width="672" height="20">
      <div align="left">
        <input name="week" type="text" id="week" value="<%=weeknum(date())%>" size="2">
		<span id="inner_From"></span>&nbsp;
        <input name="fromdate" type="text" id="fromdate" value="<%=dateadd("d",-7,date())%>" size="10" readonly="true">
    ...
    calendar1 = new dynCalendar('calendar1', 'calendar1Callback');
        ...
        <input name="fromhour" type="text" id="fromhour" value="00" size="2" onChange="checkhour(this)">
 :        
 <input name="fromminute" type="text" id="fromminute" value="00" size="2" onChange="checkminute(this)">
        &nbsp;<span id="inner_To"></span>
<input name="todate" type="text" id="todate" value="<%=date()%>" size="10" readonly="true">
...
&nbsp;
<input name="tohour" type="text" id="tohour" value="00" size="2" onChange="checkhour(this)">
      :
      <input name="tominute" type="text" id="tominute" value="00" size="2" onChange="checkminute(this)">
      </div></td>
    </tr>
  <tr>
