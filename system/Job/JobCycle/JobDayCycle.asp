...
pagename="/Job/SubJobs/Job.asp"
FactoryRight "P."
SQL="select J.*,P.PART_NUMBER,P.STATIONS_INDEX as P_STATIONS_INDEX,P.STATIONS_TRANSACTION as P_STATIONS_TRANSACTION from JOB J inner join PART P on J.PART_NUMBER_ID=P.NID where J.JOB_NUMBER is not null"&where&factorywhereoutsideand&order
...
'response.Write(session("SQLStation"))
'response.End()
%>
    ...
    <tr>
      <td height="20" colspan="13" class="t-c-greenCopy"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="52%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('Job_Export.asp')"><img src="/Images/EXCEL_Middle.gif" width="22" height="22"></span>&nbsp;<span style="cursor:hand" title="Export Detailed Data to EXCEL File" onClick="javascript:window.open('JobStation_Export.asp')"><img src="/Images/IconReportTable.gif" width="22" height="22"></span></div></td>
          </tr>
        </table></td>
    </tr>
    <tr>
...
%>
    <tr>
      <td height="20" colspan="13"><div align="center"><span id="inner_Records"></span>No Records</div></td>
    </tr>
<%end if
rs.close%>
	<tr>
      <td height="20" colspan="13"><!--#include virtual="/Components/JobNote.asp" --></td>
    </tr>
</table>
