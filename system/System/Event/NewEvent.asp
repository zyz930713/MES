...
<body>
<form name="form1" method="post" action="/System/Event/NewEvent1.asp" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
    <tr> 
      <td height="20" colspan="2" class="t-c-greenCopy">Create a New Event </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td height="20"><input name="description" type="text" id="description">      </td>
    </tr>
    <tr>
      <td height="20">Note</td>
      <td height="20"><textarea name="note" cols="50" rows="5" id="note"></textarea></td>
    </tr>
    <tr>
      <td height="20">Email body</td>
      <td height="20"><textarea name="body" cols="50" rows="5" id="body"></textarea></td>
    </tr>
