...
SQL="select * from TASK where TASK_NAME='"&taskname&"'"
rs.open SQL,conn,3,3
if rs.eof then
rs.addnew
rs("NID")="TA"&NID_SEQ("TASK")
...
rs.update
word="Successfully save New Task."
action="location.href='"&beforepath&"'"
else
word="Task of "&tasktype&" has existed, please input again."
action="history.back()"
end if
rs.close
%>
