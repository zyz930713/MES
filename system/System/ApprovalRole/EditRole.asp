...
<body>
<form name="form1" method="post" action="/System/ApprovalRole/EditRole1.asp" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
    <tr> 
      <td height="20" colspan="2" class="t-c-greenCopy">Edit an Approval Role </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td width="138" height="20">Role Name <span class="red">*</span></td>
      <td width="861" height="20"><input name="name" type="text" id="name" value="<%=rs("ROLE_NAME")%>" size="50">	  </td>
    </tr>
    <tr>
