<%
function getStationCodes(station_id,splitchar,idcount)
...
SQLO="Select CODE from OPERATORS where AUTHORIZED_STATIONS_ID like '%"&station_id&"%' order by CODE"
