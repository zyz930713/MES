...
finalseries_id=request.Form("finalseries_id")
SQL="select * from FINAL_SERIESYIELD_LIST where NID='"&finalseries_id&"'"
...
if not rs.eof then
	...
	rs.update
word="Successfully Update FINAL SERIES YIELD."
action="window.close()"
else
word="This FINAL SERIES YIELD is not existed."
action="window.close()"
end if
rs.close
%>
