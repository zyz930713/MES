...
pagename="/Reports/FinalYield/FinalSeriesYield/FinalSeriesDetailbyJobNumber.asp.asp"
SQL="select * from JOB_MASTER_STORE where instr('"&store_nids&"',NID)>0 order by JOB_NUMBER"
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="8" class="t-c-greenCopy">Browse Final Series Yield -- <%=series_name%></td>
  </tr>
  <tr>
...
<tr>
  <td height="20" colspan="8">Sort by: 
    <input name="ByNormal" type="radio" value="1" onClick="document.formSort.action='FinalSeriesDetail.asp';document.all.store_nids.value='<%=store_nids%>';document.all.series_name.value='<%=series_name%>';document.formSort.submit()">
    Normal
