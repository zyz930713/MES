...
pagename="/Reports/FinalYield/FinalFamilyYield/FinalFamilyDetail.asp"
if store_nids<>"" then
  ...
  <td height="20"><div align="center"><% =i%></div></td>
    <td><div align="center"><a href="/Job/Job/Job.asp?jobnumber=<%=rs("JOB_NUMBER")%>" target="_blank"><%= rs("JOB_NUMBER") %></a></div></td>
	  <div align="center"><td><div align="center"><%= rs("PART_NUMBER_TAG") %>&nbsp;</div></td>
	    ...
	    <td><div align="center"><a href="/Job/Store/JobStore/JobStoreDetail.asp?jobnumber=<%=rs("JOB_NUMBER")%>" target="_blank"><%= rs("STORE_QUANTITY") %></a></div></td>
