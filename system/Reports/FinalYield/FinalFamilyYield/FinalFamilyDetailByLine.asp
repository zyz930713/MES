...
line_name=trim(request.Form("line_name"))
...
pagename="/Reports/FinalYield/FinalFamilyYield/FinalFamilyDetailByLine.asp"
if store_nids<>"" then
...
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy">Browse Recorded Family Yield -- <%=family_name%></td>
</tr>
<tr>
...
<tr>
  <td height="20"><div align="center"><% =i%></div></td>
    <td><div align="center"><a href="/Job/Job/Job.asp?jobnumber=<%=rs("JOB_NUMBER")%>" target="_blank"><%= rs("JOB_NUMBER") %></a></div></td>
	  <div align="center"><td><div align="center"><%= rs("PART_NUMBER_TAG") %>&nbsp;</div></td>
	    <td><div align="center"><%= rs("LINE_NAME") %></div></td>
	    <td><div align="center"><a href="/Job/SubJobs/Job.asp?jobnumber=<%=rs("JOB_NUMBER")%>" target="_blank"><%= rs("INPUT_QUANTITY") %></a></div></td>
	    <td><div align="center"><a href="/Reports/Store/JobStore/JobStoreDetail.asp?jobnumber=<%=rs("JOB_NUMBER")%>" target="_blank"><%= rs("STORE_QUANTITY") %></a></div></td>
