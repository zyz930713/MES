...
pagename="/Reports/FinalYield/FinalFamilyYiled/GenerateFinalFamilyYieldByLine.asp"

set cmd=server.CreateObject("Adodb.Command") 
cmd.ActiveConnection=conn 
cmd.CommandText="FINAL_FAMILY_LINEYIELD"
cmd.CommandType=4 
...
rs.close
FactoryRight "S."
SQL="select * from FFAMILY_LINEYIELD_DETAIL_TEMP where CREATOR_CODE='"&session("code")&"' and RND_KEY='"&rnd_key&"' order by FAMILY_NAME,LINE_NAME"
rs.open SQL,conn,1,3
%>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="14" class="t-c-greenCopy">Browse Final Family Yield by Line (from <%=fromtime%> to <%=totime%>) </td>
  </tr>
  <tr>
    <td height="20" colspan="14" class="t-c-greenCopy">User:
    <% =session("User") %></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="t-t-Borrow"><div align="center">Retest Ouput </div></td>
    ...
    <td height="20" class="t-t-Borrow"><div align="center">Target Yield</div></td>
...
if not rs.eof then
%>
<form action="/Reports/FinalYield/FinalFamilyYield/FinalFamilyDetailByLine.asp" method="post" name="formDetail" target="_blank">
<%
...
total_inspect_yield=total_inspect_yield/total_assembly_input
...
<input name="family_name" type="hidden" value="">
  ...
  <form name="form1" method="post" action="/Reports/FinalYield/FinalFamilyYield/SaveFinalFamilyYieldByLine.asp" onSubmit="return formcheckSave()">
    <tr>
      <td height="20" colspan="14">Generating time:
...
month </td>
    ...
    <tr>
      <td height="20" colspan="14">Report name:        
