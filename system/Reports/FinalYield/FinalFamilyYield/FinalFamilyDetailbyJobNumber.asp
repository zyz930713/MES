...
pagename="/Reports/FinalYield/FinalFamilyYield/FinalFamilyDetailbyJobNumber.asp.asp"
...
%>
    <tr>
      ...
      <td height="20"><div align="center"><a href="/Job/Store/JobStore/JobStoreDetail.asp?jobnumber=<%=this_jobnumber(u)%>" target="_blank"><%= this_jobnumber(u) %></a></div></td>
