...
SQL="insert into FINAL_FAMILYYIELD_DETAIL select '"&NID&"',FAMILY_NAME,INPUT_QUANTITY,OUTPUT_QUANTITY,FINAL_YIELD,STORE_NIDS,ASSEMBLY_INPUT_QUANTITY,ASSEMBLY_OUTPUT_QUANTITY,ASSEMBLY_YIELD,FAMILY_TARGET_YIELD,OVERALL_EXCEPTION,FAMILY_TARGET_FIRSTYIELD,FAMILY_TARGET_INTERNALYIELD,INSPECT_QUANTITY,INSPECT_YIELD,FAMILY_TARGET_INSPECTYIELD from FINAL_FAMILYYIELD_DETAIL_TEMP where rnd_key='"&rnd_key&"' and CREATOR_CODE='"&session("code")&"'"
rs.open SQL,conn,1,3
SQL="select * from FINAL_FAMILYYIELD_DETAIL"
rs.open SQL,conn,1,3
rs.addnew
...
rs.update
rs.close
word="Successfully save FINAL FAMILY YIELD report at "&create_time&"."
