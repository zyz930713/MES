...
pagename="/Reports/FinalYield/FinalPartYield/FinalPartDetailbyJobNumber.asp.asp"
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="8" class="t-c-greenCopy">Browse Final Part Yield -- <%=Part_name%></td>
  </tr>
  <tr>
...
<tr>
  <td height="20" colspan="8">Sort by: 
    <input name="ByNormal" type="radio" value="1" onClick="document.formSort.action='FinalPartDetail.asp';document.all.store_nids.value='<%=store_nids%>';document.all.Part_name.value='<%=Part_name%>';document.formSort.submit()">
    Normal
