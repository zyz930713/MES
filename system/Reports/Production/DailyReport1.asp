...
'mailTo="hui.zhang@knowles.com;Jeff.xu@knowles.com;gerald.li@knowles.com;deland.diao@knowles.com;fanny.zhang@knowles.com;tim.wang@knowles.com;Dongling.Lao@knowles.com;kuigang.bi@knowles.com;guihua.jia@knowles.com;Xiaoyu.Chai@knowles.com;Steven.Zhu@knowles.com;zhenqiu.lu@knowles.com;Chunli.Yu@knowles.com;kunlun.liu@knowles.com;Presley.Pei@knowles.com;Vivian.huang@knowles.com;ivan.li@knowles.com;Young.li@knowles.com;meiquan.huang@knowles.com;Emily.Shao@knowles.com;Davide.Liu@knowles.com;benjamin.wu@knowles.com;Ted.Wang@knowles.com;Sinan.Kaptan@knowles.com;Changhu.Zhao@knowles.com;zhiyong.zhai@knowles.com;cassie.zhang@knowles.com;Fred.Yuan@knowles.com"
...
htmls=htmls&"<tr align='center'><th style='font-size:24px;' >Daily Production Report - KEB IT Internal Test</th><td width='30px' rowspan='2' align='right'><img  width='150px' height ='90px' src='http://"&application("HostServer")&"/Images/rpt-logo.jpg'>&nbsp;</td></tr>"
...
htmls=htmls&"<tr ><td><b>Author:&nbsp;</b>Zhang Hui</td><td><b>Print Date:&nbsp;</b>"&formatdate(now(),"dd.mm.yyyy")&"</td></tr></table>"
...
htTotal=htTotal&"<td colspan='2'><b>Job Quantity</b></td><td colspan='2'><b>TTY</b></td></tr>"
...
htTotal=htTotal&"<td ><b>Real</b></td><td ><b>Target</b></td><td ><b>Real</b></td><td ><b>Job Open</b></td><td ><b>Job Close</b></td><td ><b>Target</b></td><td ><b>Real</b></td></tr>"


'detail
htDetl="<table width='100%' border='1' cellpadding='0' cellspacing='0' ><tr align='center' bgcolor='#B9E9FF'><td colspan='27'><b>Details Beijing(Semi):</td></tr>"
...
htDetl=htDetl&"<td colspan='4'><b>Process Yield</b></td><td colspan='4'><b>Acoustic Yield</b></td><td colspan='4'><b>Cosmetic Yield</b></td><td colspan='4'><b>Leakage Yield</b>"
htDetl=htDetl&"<td colspan='2'><b>Job Quantity</b></td><td colspan='2'><b>TTY</b></td></tr>"
...
htDetl=htDetl&"<tr align='center' bgcolor='#B9E9FF'><td ><b>Target</b></td><td ><b>Input</b></td><td ><b>Output</b></td><td ><b>Real</b></td><td ><b>Target</b></td><td ><b>Input</b></td><td ><b>Output</b></td><td ><b>Real</b></td><td ><b>Target</b></td>"
htDetl=htDetl&"<td ><b>Input</b></td><td ><b>Output</b></td><td ><b>Real</b></td><td ><b>Target</b></td><td ><b>Input</b></td><td ><b>Output</b></td><td ><b>Real</b></td><td ><b>Job Open</b></td><td ><b>Job Close</b></td><td ><b>Target</b></td><td ><b>Real</b></td></tr>"
...
htmlDesc=htmlDesc&"<tr><td width='60px'>Remarks</td><td style='font-size:14px;'>This reprot not included rework  JO and QYT   &  Line No N = NPI Line </td></tr></table>"
...
for i=0 to rs.recordcount 
	...
	if rs.eof or tempProduct <> product then
		...
		htDetl=htDetl&"<td><b>"&round(subProcTargetYield*100,2)&"%</b></td>"
		if subProcJobQty>0 then		
			...
			htDetl=htDetl&"<td><B>"&subProcJobQty&"</B>&nbsp;</td><td><B>"&subProcQty&"</b>&nbsp;</td><td><font color='"&fontColor&"' ><b>"&round(subProcYield*100,2)&"%</b></font>"
			else
		htDetl=htDetl&"<td>-</td><td>-</td><td>"
		htDetl=htDetl&"-</td>"
		...
		htDetl=htDetl&"<td><b>"&round(subAcousticTargetYield*100,2)&"%</b></td>"
		if subAcousticJobQty>0 then
			...
			htDetl=htDetl&"<td><B>"&subAcousticJobQty&"</b></td><td><B>"&subAcousticQty&"<B></td><td><font color='"&fontColor&"' ><b>"&round(subAcousticYield*100,2)&"%</b></font>"
			else
		htDetl=htDetl&"<td>-</td><td>-</td><td>"
		htDetl=htDetl&"-</td>"
		...
		htDetl=htDetl&"<td><b>"&round(subFoiTargetYield*100,2)&"%</b></td>"
		if subFoiJobQty>0 then
			...
			htDetl=htDetl&"<td><b>"&subFoiJobQty&"</b></td><td><b>"&subFoiQty&"</b></td><td><font color='"&fontColor&"' ><b>"&round(subFoiYield*100,2)&"%</b></font>"
		else
		htDetl=htDetl&"<td>-</td><td>-</td><td>"
		htDetl=htDetl&"-</td>"
	...
	'	htDetl=htDetl&"&nbsp;</td>"
		...
		htDetl=htDetl&"<td><b>"&round(subLeakageTargetYield*100,2)&"%</b></td>"
		if subLeakageJobQty>0 then
			...
			htDetl=htDetl&"<td><B>"&subLeakageJobQty&"</b></td><td>"&subLeakageQty&"</td><td>"
		...
		htDetl=htDetl&"<td><font color='"&fontColor&"' ><b>"&subFpyJobQty&"</b></font>"   'Total Job Close
		htDetl=htDetl&"&nbsp;</td><td>"	
	...
	if left(rs("LINE"),1)="N" then
	
	htDetl=htDetl&"<tr align='center'><td>"&product&"</td><td>"&rs("LINE")&"</td><td>"&rs("TARGET")&"</td><td>"
...
'------------------------------------------------------------------------------------------	
	'get process_yield 
	htDetl=htDetl&"<td>"&round(csng(rs("PROCESS_YIELD_TARGET"))*100,2)&"%</td>"
	totalProcTargetQty=totalProcTargetQty+csng(rs("PROCESS_TARGET"))
	subProcTargetQty=subProcTargetQty+csng(rs("PROCESS_TARGET"))	
	
	if tempProduct = "Winslet" or tempProduct = "Marigold" or tempProduct="Pansy" then 
	...
	if not rsReal.eof and not isnull(rsReal("proc_job_qty")) then		
		...
		if yield < csng(rs("PROCESS_YIELD_TARGET")) then
			...
			htDetl=htDetl&"<td>"&csng(rsReal("proc_job_qty"))+csng(proc_job_qty690)&"</td><td>"&csng(rsReal("proc_qty"))&"</td><td><font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
	...
	'------------------------------------------------------------------------------------------
	'get Acoustic_Yield 
	htDetl=htDetl&"<td>"&round(csng(rs("ACOUSTIC_YIELD_TARGET"))*100,2)&"%</td>"
	...
	'	htDetl=htDetl&"<font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
			htDetl=htDetl&"<td>"&csng(rsReal("acoustic_job_qty"))&"</td><td>"&csng(rsReal("acoustic_qty"))&"</td><td><font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
    else
	    htDetl=htDetl&"<td>-</td><td>-</td><td>"
        htDetl=htDetl&"-</td>"
	end if
...
'------------------------------------------------------------------------------------------
	'get Foi_Yield 
	htDetl=htDetl&"<td>"&round(csng(rs("FOI_YIELD_TARGET"))*100,2)&"%</td>"
	...
	if not rsReal.eof and not isnull(rsReal("foi_job_qty")) then		
		...
		'htDetl=htDetl&"<font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
		htDetl=htDetl&"<td>"&csng(rsReal("foi_job_qty"))&"</td><td>"&csng(rsReal("foi_qty"))&"</td><td><font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
    else
	    htDetl=htDetl&"<td>-</td><td>-</td><td>"
        htDetl=htDetl&"-</td>"
	end if
	...
	if not rsReal.eof and not isnull(rsReal("LEAKAGE_job_qty")) then		
		...
		htDetl=htDetl&"&nbsp;"&csng(rsReal("LEAKAGE_job_qty"))&"</td><td>"&csng(rsReal("LEAKAGE_qty"))&"</td><td>"
		htDetl=htDetl&"<font color='"&fontColor&"'>"&round(yield*100,2)&"%</font>"
	else
	    htDetl=htDetl&"-</td><td>-</td><td>"
        htDetl=htDetl&"-</td>"
	end if
...
'	htDetl=htDetl&"&nbsp;</td>"
	...
	if not rsReal.eof and not isnull(rsReal("fpy_job_qty")) then		
		...
		htDetl=htDetl&"<td>"&csng(rsReal("fpy_job_qty"))&"</td>"
		htDetl=htDetl&"<td>"&csng(rsReal("fpy_qty"))&"</td>"
...
subHTTotal=subHTTotal&"<td><font color='"&fontColor&"' >"&totalFpyJobQty&"</font>"	'beijing total  job close
subHTTotal=subHTTotal&"&nbsp;</td><td>"
...
subHTTotalNew=subHTTotalNew&"<td><font color='"&fontColor&"' ><b>"&totalFpyJobQty&"</b></font>"	'beijing total  job close
subHTTotalNew=subHTTotalNew&"&nbsp;</td><td>"
...
SendJMail application("MailSender"),mailTo,"BPS Daily Report ---Production Internal team  "&mailTitleFromDate,mailContents
