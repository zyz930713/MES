...
htmls=htmls&"<td colspan='2' align='center'><span style='height:40px;line-height:40px;font-size:24px;'><b>Weekly Production Report - KEB IT Internal</b></span></td>"
...
if MailSwitch > 0 then
	select case MailSwitch
			case 1
				mailto="chao.yao@knowles.com;Young.Li@knowles.com"
			case 2
				mailto="Rong.Ren@knowles.com;yan.meng@knowles.com;bl.wang@knowles.com;hui.zhang@knowles.com;Xuehui.Chen@knowles.com;mark.fan@knowles.com;fanny.zhang@knowles.com;kunlun.liu@knowles.com;Vivian.Huang@knowles.com;Ivan.li@knowles.com;Young.Li@knowles.com;bo.wang@knowles.com;chao.yao@knowles.com"
			case 3
...
<%
	SendJMail application("MailSender"),mailTo,"Weekly Production Report - " &fromTime&" - "&toTime,mailContents
else
	response.Write(mailContents)
end if
...
function TitelTable(TitelName)
	...
	TotalTitel=TotalTitel&"<td rowspan='2' width='6%'><b>Actual<br>[pcs]</b></td>"
...
function ProdTypeTable(ProdType)
	TypeTitel="<table width='100%' border='1' cellpadding='0' cellspacing='0' ><tr align='center' bgcolor='#DCE6F1'><td colspan='14'><b>"&ProdType&"</b></td></tr>"
	...
	TypeTitel=TypeTitel&"<td rowspan='2' width='6%'><b>Actual<br>[pcs]</b></td>"
