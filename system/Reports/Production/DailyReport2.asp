...
'MailTo="hui.zhang@knowles.com;deland.diao@knowles.com;kuigang.bi@knowles.com;brent.liu@knowles.com;ivan.li@knowles.com;Young.li@knowles.com;fanny.zhang@knowles.com;guihua.jia@knowles.com;kunlun.liu@knowles.com;Vivian.huang@knowles.com"
...
htmls=htmls&"<tr align='center'><th style='font-size:24px;' >Goldberg Maple Marigld BPS REPORT INTERNAL TEST</th><td width='30px' rowspan='2' align='right'><img src='http://"&application("HostServer")&"/Images/rpt-logo.jpg'>&nbsp;</td></tr>"
...
htTotal=htTotal&"<td ><b>Real</b></td><td ><b>Target</b></td><td ><b>Real</b></td><td ><b>Job Open</b></td><td ><b>Job Close</b></td></tr>"


'detail
htDetl="<table width='100%' border='1' cellpadding='0' cellspacing='0' ><tr align='center' bgcolor='#B9E9FF'><td colspan='15'><b>Details Beijing(Semi):</td></tr>"
...
htDetl=htDetl&"<td ><b>Real</b></td><td ><b>Target</b></td><td ><b>Real</b></td><td ><b>Job Open</b></td><td ><b>Job Close</b></td></tr>"
...
for i=0 to rs.recordcount 
	...
	sql="select sum(packed_qty) as toWHQty from job_pack_detail where packed_line ='"&rs("LINE")&"' and WHREC_time between to_date('"&fromTime&"','dd.mm.yyyy hh24:mi') and to_date('"&toTime&"','dd.mm.yyyy hh24:mi') AND  substr(job_number,1,3)<>'RWK'"
	rsReal.open sql,conn,1,3
...
SendJMail application("MailSender"),mailTo,"Maple Marigld  BPS REPORT INTERNAL TEST"&mailTitleFromDate,mailContents
%>
