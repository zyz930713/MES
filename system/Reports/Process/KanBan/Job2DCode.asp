...
if action="GenereateReport" then
	...
	if jobnumber<>"" then
		...
		'strWhere=strWhere+" and job_number like '%"+jobnumber+"%'"
		if sheetNumber <> "" then
	...
	if code<>"" then
		strWhere=strWhere+" and code like '%"+code+"%'"
	end if
	
	sql="SELECT CODE,JOB_NUMBER,SHEET_NUMBER,LM_USER,LM_TIME,BOX_ID,PACK_TIME,PACK_USER,B.DEFECT_CODE,B.DEFECT_NAME,B.DEFECT_CHINESE_NAME,rownum rn FROM JOB_2D_CODE A LEFT JOIN DEFECTCODE B ON A.DEFECT_CODE_ID = B.NID "	
...
<body onLoad="language('<%=session("language")%>');language_page();">
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
        ...
        <tr align="center">
            ...
            <td width="100">
                <input name="fromdate" type="text" id="fromdate" value="<%=fromdate%>" readonly size="10">
            ...
            <td width="100">
                <input name="todate" type="text" id="todate" value="<%=todate%>" readonly size="10">
                <script language="JavaScript" type="text/javascript">
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF"> 
        ...
        <tr>
			...
			<td height="20" class="t-t-Borrow"><div align="center"><span id="td_PackTime"></span></div></td>
			<td height="20" class="t-t-Borrow"><div align="center"><span id="td_PackUser"></span></div></td>
