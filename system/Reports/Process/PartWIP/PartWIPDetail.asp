...
part_number_tag=request.Form("part_number_tag")
job_numbers=request.Form("job_numbers")
part_WIP_name=trim(request.Form("part_WIP_name"))
part_WIP_report_time=trim(request.Form("part_WIP_report_time"))
...
pagename="/Reports/PartWIP/PartWIPDetail.asp"
...
<tr>
  <td height="20"><div align="center"><% =i%></div></td>
    ...
    <%
	  ...
	  j=0
	  While not rsT.eof%>
	  <div align="center"><td><div align="center"><%station_quantity=getWIPJobQuantity(rs("JOB_NUMBER"),rs("SHEET_NUMBER"),rsT("NID"),rsT("WIP_INCLUDED_STATIONS"))%><%=station_quantity%>&nbsp;</div></td></div>
	  <%
