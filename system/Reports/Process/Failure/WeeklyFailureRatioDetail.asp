...
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy">Browse Recorded Weekly Station Yield -- from <%=from_time%> to <%=to_time%></td>
</tr>
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%">User:
          <% =session("User") %></td>
        <td width="50%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('DailyFailureRatioDetail_Export.asp?report_type=WE&station_id=<%=station_id%>&defectcode_id=<%=defectcode_id%>&from_time=<%=from_time%>&to_time=<%=to_time%>')"><img src="/Images/EXCEL.gif" width="30" height="30"></span></div></td>
      </tr>
    </table></td></tr>
<!--<tr>
