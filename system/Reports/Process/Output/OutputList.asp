...
<body>
<form name="form1" method="post" action="/Reports/Process/Output/OutputList.asp">
...
<tr>
  <td height="20" colspan="7" class="t-c-greenCopy"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<%if admin=true then%>
          <form action="/Reports/Process/Output/GenerateOutput.asp" method="post" name="form2" target="_self" onSubmit="return form2check()">
<tr>
