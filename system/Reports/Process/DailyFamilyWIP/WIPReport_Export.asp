...
rs.open SQL,conn,1,3
	...
	sheet.cells(2,3).value="WIP Quantity"
	...
	sheet.cells(2,4).value="WIP Target"
	...
	sheet.cells(2,5).value="Report Time"
	...
	While not rs.eof	
		...
		sheet.cells(i,4).value=rs("WIP_TARGET")
		sheet.cells(i,5).value=formatdate(rs("REPORT_TIME"),application("longdateformat"))
		i=i+1
	rs.movenext
	wend
	end if
