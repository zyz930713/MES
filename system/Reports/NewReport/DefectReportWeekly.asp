...
<script>
	...
	{
		form1.action="DefectReportWeekly.asp?Action=LoadNextItem"
		form1.submit();
	}
	...
	function GenerateReport()
	{
		...
		form1.action="DefectReportWeekly.asp?Action=GenereateReport"
		form1.submit();
	}
</script>
...
<body>
<form action="DefectReportWeekly.asp" method="post" name="form1" target="_self" id="form1">
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="8" class="t-b-midautumn">Weekly FPY Report</td>
  </tr>
  <tr>
