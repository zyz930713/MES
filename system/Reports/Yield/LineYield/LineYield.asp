...
order=" order by J.LINE_NAME asc,J.JOB_NUMBER asc,J.SHEET_NUMBER asc"
else
...
<body>
<form name="form1" method="post" action="/Reports/Yield/LineYield/LineYield.asp">
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy">Browse Line Yield </td>
</tr>
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%" class="t-c-greenCopy">User: 
          <% =session("User") %></td>
        <td width="50%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('LineYield_Export.asp')"><img src="/Images/EXCEL.gif" width="30" height="30"></span></div></td>
      </tr>
    </table></td>
</tr>
<tr>
...
<tr>
  ...
  <td class="t-t-Borrow"><div align="center"> Actual Yield </div></td>
  </tr>
<%
i=1
if not rs.eof then
...
while not rs.eof
  ...
  <td height="20"><div align="center"><% =t%></div></td>
    <td><span style="cursor:hand" onClick="tabplus('<%=current_linename%>')">
      <input name="tabstatus<%=current_linename%>" type="hidden" value="0">
      <img src="/Images/Treeimg/plus.gif" name="tabimg<%=current_linename%>" width="9" height="9">&nbsp;<%= current_linename %></span></td>
	...
	<tbody id="tab<%=current_linename%>" style="display:none">
<%
