...
<form action="" method="post" name="form1" target="_self" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#006600" bordercolordark="#DFDFDF">
    <tr>
      <td height="20" colspan="2" class="t-c-greenCopy">Ontime Operator Yield Selection </td>
    </tr>
    <tr>
      <td width="11%" class="t-b-blue">Report Name</td>
      <td width="89%"><input name="report_name" type="text" id="report_name" value="<% =session("user")&"'s Operator Yield Report on "&now()%>" size="50"></td>
    </tr>
    <tr>
      <td class="t-b-blue">Factory <span class="red">*</span> </td>
    ...
    <tr>
      ...
      <td><select name="station" size="5" multiple id="station">
        <option value="">-- Select --</option>
		<%FactoryRight "S."%>
    ...
    <tr>
      <td class="t-b-blue">Operator</td>
      <td><input name="operator" type="text" id="operator"></td>
    </tr>
    <tr>
...
by day </td>
    ...
    <tr>
      <td colspan="2"><div align="center">
        ...
        <input name="Generate" type="submit" class="t-b-Yellow" id="Generate" value="Generate Email Report" onClick="javascript:document.form1.action='OnTimeOperatorYield1.asp'">
        &nbsp;
