...
pagename="/Reports/Yield/DailyLineYieldYield/DailyLineYieldDetail.asp"
...
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy">Browse Recorded Daily Line Yield of <%=family_name%> -- <%=line_name%> (<%=from_time%> - <%=to_time%>) </td>
</tr>
<tr>
