...
pagename="/Reports/Yield/DailyStockYieldYield/DailyStockYieldDetail.asp"
...
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy">Browse Recorded Daily Stock Yield of <%=family_name%> -- <%=line_name%> (<%=from_time%> - <%=to_time%>) </td>
</tr>
<tr>
  <td height="20" colspan="9" class="t-c-greenCopy"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%">User:
          <% =session("User") %></td>
        <td width="50%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('DailyStockYieldDetail_Export.asp?family_name=<%=family_name%>&line_name=<%=line_name%>&from_time=<%=from_time%>&to_time=<%=to_time%>')"><img src="/Images/EXCEL.gif" width="30" height="30"></span></div></td>
      </tr>
    </table></td></tr>
<tr>
