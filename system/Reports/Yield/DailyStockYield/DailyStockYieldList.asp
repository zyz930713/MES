...
<!--#include virtual="/Functions/GetDailyStockYieldByDay.asp" -->
...
pagename="/Reports/Yield/DailyStockYield/DailyStockYieldList.asp"
FactoryRight ""
%>
...
<script language="JavaScript" src="/Reports/Yield/DailyStockYield/formcheck.js" type="text/javascript"></script>
</head>

<body>
<form action="/Reports/Yield/DailyStockYield/DailyStockYieldReport.asp" method="post" name="form1" target="_blank" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#006600" bordercolordark="#DFDFDF">
    ...
    <tr>
      ...
      <td><select name="profile_task_id" id="profile_task_id">
          ...
          <%= getProfileTask("OPTION",""," and (lower(TASK_NAME) like '%daily family stock yield%' or lower(TASK_NAME) like '%daily series line yield%')"," order by TASK_NAME","") %>
      </select></td>
    ...
    calendar1 = new dynCalendar('calendar1', 'calendar1Callback');
        ...
        <input name="fromhour" type="text" id="fromhour" value="14:30" size="5">
&nbsp;to
...
&nbsp;
<input name="tohour" type="text" id="tohour" value="14:30" size="5"></td>
      <td><input name="Generate" type="submit" class="t-b-Yellow" id="Generate" value="Multi-Day Report">
      &nbsp;
      <input name="ontime" type="button" class="t-t-DarkBlue" id="ontime" value="Ontime Report" onClick="location.href='OnTimeStockYield.asp'"></td>
    </tr>
  </table>
</form>
    ...
    <td height="20" colspan="7" class="t-c-greenCopy">
      <table width="100%" cellpadding="0" cellspacing="0" byield="0">
        <tr>
          ...
          <td><div align="center">Daily Stock Yield of 
  ...
  <tr>
    <%		bgimg=""
			...
			if weekday(dates)=i and year(dates)=thisyieldyear and month(dates)=thisyieldmonth then
				yields=GetDailyStockYieldByDay(dates)
				if i=1 then
