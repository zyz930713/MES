...
<script language="JavaScript" src="/Reports/Yield/DailyStockYield/OnTimeFormcheck.js" type="text/javascript"></script>
</head>

<body>
<form action="/Reports/Yield/DailyStockYield/OnTimeStockYield1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#006600" bordercolordark="#DFDFDF">
    <tr>
      <td height="20" colspan="2" class="t-c-greenCopy">Ontime Stock Yield  Selection </td>
    </tr>
    <tr>
      <td width="11%" class="t-b-blue">Report Name</td>
      <td width="89%"><input name="report_name" type="text" id="report_name" value="<% =session("user")&"'s Stock Yield Report on "&now()%>" size="50"></td>
    </tr>
    <tr>
...
<input name="tominute" type="text" id="tominute" value="<%=minute(now())%>" size="2"></td>
    ...
    <tr>
      <td colspan="2"><div align="center">
        ...
        <input name="Generate" type="submit" class="t-b-Yellow" id="Generate" value="Generate">
      </div></td>
    </tr>
  </table>
</form>
