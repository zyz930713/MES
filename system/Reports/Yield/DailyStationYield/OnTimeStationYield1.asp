...
to_time=request.Form("todate")&" "&request.Form("tohour")&":"&request.Form("tominute")
	...
	cmd.CommandText="BAR_REPORT.RUN_ONTIME_STATIONYIELD"
	cmd.CommandType=4
'	response.Write(report_name&"#"&session("code")&"#"&session("user")&"#"&factory_id&"#"&seriesgroup&"#"&series&"#"&from_time&"#"&to_time)
'	response.End()
	...
	cmd.Parameters.Append cmd.CreateParameter("v_seriesgroup", adVarChar, adParamInput, 20, seriesgroup)
