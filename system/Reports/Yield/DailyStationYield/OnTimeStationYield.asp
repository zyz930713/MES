...
<script language="JavaScript" src="/Reports/Yield/DailyStationYield/OnTimeFormcheck.js" type="text/javascript"></script>
</head>
...
<form action="" method="post" name="form1" target="_self" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#006600" bordercolordark="#DFDFDF">
    <tr>
      <td height="20" colspan="2" class="t-c-greenCopy">Ontime Station Yield Selection </td>
    </tr>
    <tr>
      <td width="11%" class="t-b-blue">Report Name</td>
      <td width="89%"><input name="report_name" type="text" id="report_name" value="<% =session("user")&"'s Station Yield Report on "&now()%>" size="50"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="t-b-blue">Family</td>
      <td><select name="seriesgroup" id="seriesgroup">
	  <option value="">-- Select --</option>
	  <%=getSeriesGroup("OPTION",seriesgroup,null,null,null)%>
      </select>      </td>
    </tr>
    <tr>
      <td class="t-b-blue">Series</td>
      <td><select name="series" id="series">
        <option value="">-- Select --</option>
        <%=getSeries("OPTION",series,null,null,null)%>
      </select></td>
    </tr>
    <tr>
...
<input name="tominute" type="text" id="tominute" value="<%=minute(now())%>" size="2"></td>
    ...
    <tr>
      <td colspan="2"><div align="center">
        ...
        <input name="Generate" type="submit" class="t-b-Yellow" id="Generate" value="Generate Email Report" onClick="javascript:document.form1.action='OnTimeStationYield1.asp'">
        &nbsp;
