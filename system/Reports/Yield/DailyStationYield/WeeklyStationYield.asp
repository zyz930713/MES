...
<body>
<form action="/Reports/Yield/DailyStationYield/WeeklyStationYield1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#006600" bordercolordark="#DFDFDF">
    <tr>
      <td height="20" colspan="2" class="t-c-greenCopy"><p>Weekly Station Yield Selection</p></td>
    </tr>
