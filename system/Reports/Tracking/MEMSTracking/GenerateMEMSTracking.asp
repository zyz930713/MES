...
if not rs.eof then
	while not rs.eof 
		if rs("MEMS_LOT")<>"" then
			...
			if isnumeric(a_MEMS_quantity(i)) and a_MEMS_quantity(i)<>"" then
...
<body>
 <form name="form1" method="post" action="/Reports/Tracking/MEMSTracking/GenerateMEMSTracking.asp">
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="7" class="t-c-greenCopy"><span>Search MEMS Tracking </span></td>
  </tr>
  <tr>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="24" class="t-c-greenCopy">Browse MEMS Tracking form <% =formatdate(fromdate,application("shortdateformat"))%> to <% =formatdate(todate,application("shortdateformat"))%></td>
</tr>
<tr>
...
<tr>
  <td height="20" colspan="24"><span title="MEMS Quanity in following jobs has error, please revise it and try again."><span class="strongred">Error jobs:</span> <%= thiserror %></span></td>
</tr>
<tr>
...
wend
%>
<form name="form2" method="post" action="/Reports/Tracking/MEMSTracking/SaveMEMSTracking.asp">
  <tr>
...
&nbsp;</td>
  ...
  <tr>
    <td height="20" colspan="24">Report name:
      <input name="MEMS_name" type="text" id="MEMS_name">
