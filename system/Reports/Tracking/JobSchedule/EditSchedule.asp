...
<body>
<form name="form1" enctype="multipart/form-data" method="post" action="/Reports/Tracking/JobSchedule/EditSchedule1.asp">
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="2" class="t-c-greenCopy">Import Schedule </td>
  </tr>
  <tr>
    <td width="17%" height="20"><span class="style1">Year</span></td>
    <td width="83%" height="20"><input name="yearindex" type="text" id="yearindex" value="<%=rs("YEAR_INDEX")%>" size="6"></td>
  </tr>
  <tr>
    <td height="20">Week Index </td>
    <td height="20">
	  <input name="weekindex" type="text" id="weekindex" value="<%=rs("WEEK_INDEX")%>" size="4">
...
&nbsp; </td>
  ...
  <tr>
    ...
    <td height="20">
      <input name="weekstartday" type="text" id="weekstartday" value="<%=formatdate(rs("WEEK_START_DAY"),application("shortdateformat"))%>" size="10">
      <script language=JavaScript type=text/javascript>
  ...
  <tr>
    ...
    <td height="20"><input name="weekendday" type="text" id="weekendday" value="<%=formatdate(rs("WEEK_END_DAY"),application("shortdateformat"))%>" size="10">
      <script language=JavaScript type=text/javascript>
...
&nbsp; </td>
  ...
  <tr>
    ...
    <td height="20"><input name="schedulename" type="text" id="schedulename" value="<%=rs("SCHEDULE_NAME")%>"></td>
  </tr>
  <tr>
    <td height="20"> Re-upload File </td>
    <td height="20"><input name="reuploadcheck" type="checkbox" id="reuploadcheck" value="1" onClick="javascript:if(this.checked){document.all.loadagain.value='1'}else{document.all.loadagain.value='0'}"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="20" colspan="2"><div align="center">
      ...
      <input name="loadagain" type="hidden" id="loadagain" value="0">
