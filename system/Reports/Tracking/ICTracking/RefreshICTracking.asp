...
pagename="/Reports/Tracking/ICTracking/RefreshICTracking.asp"
...
<body>
<form name="form1" method="post" action="/Reports/Tracking/ICTracking/RefreshICTracking.asp">
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <tr>
    <td height="20" colspan="7" class="t-c-greenCopy"><span>Refresh IC Tracking </span></td>
  </tr>
  <tr>
...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="44" class="t-c-greenCopy">Refresh IC Tracking form <% =formatdate(fromdate,application("shortdateformat"))%> to <% =formatdate(todate,application("shortdateformat"))%></td>
</tr>
<tr>
...
<tr>
  <td height="20" colspan="44" class="strongred"><span title="MEMS Quanity in following jobs has error, please revise it and try again."><span class="strongred">Error jobs:</span> <%= thiserror %></span></td>
</tr>
<tr>
...
wend
%>
<form name="form2" method="post" action="/Reports/Tracking/ICTracking/RefreshICTracking1.asp">
  <tr>
    <td height="20" colspan="44">Refresh time:
      <% =formatdate(create_time,application("longdateformat"))%>
&nbsp;</td>
  </tr>
  <tr>
    <td height="20" colspan="44">Report name:
      <input name="IC_name" type="text" id="IC_name" value="<%=IC_name%>">
