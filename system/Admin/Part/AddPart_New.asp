...
<form action="/Admin/Part/AddPart_New1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
<table width="760"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="2" class="t-c-greenCopy">Add a New  Part </td>
</tr>
<tr>
  ...
  <tr>
  	<td height="20">Part Type  <span class="red">*</span></td>
	<td height="20">
		<select name="partType" id="factory">
		  <option value="">-- Select Type --</option>
		  <option value="0">Normal</option>
		  <option value="1">Rework</option>
		  <option value="2">Slapping</option>
		</select>
	</td>
  </tr>
  <tr>
