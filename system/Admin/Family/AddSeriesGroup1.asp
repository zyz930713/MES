...
SQL="select * from Family where FAMILY_NAME='"&seriesgroupname&"'"
rs.open SQL,conn,1,3
if rs.eof then
rs.addnew
rs("NID")="FA"&NID_SEQ("SERIES_GROUP")
rs("FAMILY_NAME")=seriesgroupname
...
rs.update
rs.close
word="Successfully save a New Family."
action="location.href='"&beforepath&"'"
else
word="Family of "&seriesgroupname&" has existed, please input again."
action="history.back()"
end if
%>
