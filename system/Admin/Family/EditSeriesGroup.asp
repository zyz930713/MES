...
SQL="select * from FAMILY where NID='"&id&"'"
...
<form action="/Admin/FAMILY/EditSeriesGroup1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
...
<tr>
  <td width="100" height="20"><div align="left"><span id="td_Family"></span><span class="red">*</span> </div></td>
    <td height="20" class="red">
      <div align="left">
        <input name="seriesgroupname" type="text" id="seriesgroupname" value="<%=rs("FAMILY_NAME")%>">
      </div></td>
    </tr>
<tr>
