...
<form action="/Admin/Factory/EditFactory1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
...
<tr>
  <td width="100" height="20"><span id="td_Factory"></span><span class="red">*</span> </td>
    <td height="20" class="red">
      <div align="left">
        <input name="factoryname" type="text" id="factoryname" value="<%=rs("FACTORY_NAME")%>">
      </div></td>
    </tr>
<tr>
...
<tr>
  ...
  <td height="20" ><input name="finalyield" type="text" id="finalyield" value="<%=rs("TARGET_YIELD")%>">
    %</td>
</tr>
  <tr>
