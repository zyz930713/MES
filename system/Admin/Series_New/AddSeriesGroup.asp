...
<form action="/Admin/SERIES_NEW/AddSeriesGroup1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
...
<tr>
  <td width="20%" height="20"><span id="td_Series"></span><span class="red">*</span> </td>
  <td  height="20">
      <div align="left">
...
<tr>
  ...
  <td height="20"><select name="family" id="family">
    <option value=""></option>
    <%= getFamily("OPTION","",factorywhereoutside,"","") %>
  </select>  </td>
</tr>
<!--
<tr>
