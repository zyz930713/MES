...
SQL="update SERIES_NEW set STATUS=1 where NID='"&id&"'"
rs.open SQL,conn,3,3
SystemLog "Admin - Series ","Enable Series Group of "&seriesgroupname&" ("&id&")"
word="Series of "&seriesgroupname&" is enabled!"
%>
