...
FactoryRight "SR."
SQL="select SR.*,F.FACTORY_NAME,S.SECTION_NAME,L.LINE_NAME from SERIES SR inner join FACTORY F on SR.FACTORY_ID=F.NID left join SECTION S on SR.SECTION_ID=S.NID left join LINE L on SR.LINE_ID=L.NID where 1=1 "&where&factorywhereoutsideand&" order by SR.SERIES_NAME"
session("SQL")=SQL
