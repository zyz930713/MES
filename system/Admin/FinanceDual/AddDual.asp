...
<body>
<form action="/Admin/FinanceDual/AddDual1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
<table width="760"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="2" class="t-c-greenCopy">Add a Daul Settings </td>
</tr>
<tr>
  <td width="161" height="20">Dual Model Name  <span class="red">*</span> </td>
  <td width="593" height="20">
      <div align="left">
        <input name="Dual" type="text" id="Dual" size="30">
      </div></td>
    </tr>
<tr>
  <td height="20">Single Model Name 1  <span class="red">*</span></td>
  <td height="20"><input name="Single1" type="text" id="Single1" size="30"></td>
</tr>
<tr>
  <td height="20">Single Model Name 2 <span class="red">*</span></td>
  <td height="20"><input name="Single2" type="text" id="Single2" size="30"></td>
</tr>
  <tr>
