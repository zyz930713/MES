...
<form action="/Admin/Section/AddSection1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
...
<tr>
  <td width="100" height="20"><span id="td_Section"></span><span class="red">*</span> </td>
  <td height="20" class="red">
      <div align="left">
        <input name="sectionname" type="text" id="sectionname">
      </div></td>
    </tr>
<tr>
