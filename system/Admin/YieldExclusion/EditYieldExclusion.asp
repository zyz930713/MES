...
<body onLoad="selectedcount();refreshmodel('fromitem','document.form1.models_filter_notin.value','');">
<div id="filterDiv" style="visibility: hidden; position: absolute"><iframe id="filterFrame"></iframe></div>
<form action="/Admin/YieldExclusion/EditYieldExclusion1.asp" method="post" name="form1" target="_self" onSubmit="return formcheck()">
<table width="760"  border="1" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
<tr>
  <td height="20" colspan="2" class="t-c-greenCopy">Edit a Yield Exclusion   </td>
</tr>
<tr>
  <td width="155" height="20"><div align="left">Yield Exclusion Name<span class="red">*</span> </div></td>
    <td width="599" height="20" class="red">
      <div align="left">
        <input name="yield_exclusion_name" type="text" id="yield_exclusion_name" value="<%=rs("YIELD_EXCLUSION_NAME")%>">
      </div></td>
    </tr>
<tr>
  ...
  <td height="20"><div align="center">
    <table  border="1" align="left" cellpadding="0" cellspacing="0" bordercolorlight="#73A2EE" bordercolordark="#FFFFFF">
       <%
		...
		where=" and segment1 like '%-_____-%' and segment1 not in ('"&replace(rs("INCLUDED_SYSTEM_ITEMS"),",","','")&"') and segment1 not in ('"&excluded_models&"')"&modelfactoryand
		else
      ...
      <tr>
        ...
        <td rowspan="7"><select name="toitem" size="10" multiple id="toitem">
          <%where=""
			ModelFactoryRight
			if rs("INCLUDED_SYSTEM_ITEMS")<>"" then
			where=" and segment1 like '%-_____-%' and segment1 in ('"&replace(rs("INCLUDED_SYSTEM_ITEMS"),",","','")&"')"
			%>
