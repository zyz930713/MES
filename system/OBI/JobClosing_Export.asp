...
rs.open SQL,conn,1,3
	...
	sheet.cells(1,1).value="OBI Error for Store"
	...
	sheet.cells(2,7).value="Last Update Time"
	...
	sheet.cells(2,8).value="ERP Job Status"
	...
	sheet.cells(2,9).value="ERP Error Code"
	...
	sheet.cells(2,10).value="ERP Error Explanation"
...
while not rs.eof
	...
	sheet.cells(i,7).value=formatdate(rs("ERP_LAST_UPDATE_TIME"),application("longdateformat"))
	sheet.cells(i,8).value=rs("ERP_JOB_STATUS")
	sheet.cells(i,9).value=rs("ERP_ERROR_CODE")
	sheet.cells(i,10).value=rs("ERP_ERROR_EXPLANATION")
i=i+1
rs.movenext
wend
