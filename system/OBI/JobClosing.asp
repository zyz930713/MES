...
<tr>
  <td height="20" colspan="14" class="t-c-greenCopy">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%" class="t-c-greenCopy"><span id="inner_User"></span>: 
          <% =session("User") %></td>
        <td width="50%"><div align="right"><span style="cursor:hand" title="Export Data to EXCEL File" onClick="javascript:window.open('JobClosing_Export.asp')"><img src="/Images/EXCEL_Middle.gif" width="22" height="22"></span>&nbsp;</div></td>
      </tr>
    </table>	</td>
</tr>
<tr>
...
<%if OBI=true then%>
		...
		<td><%if rs("PRINT_ID")<>"" then
		a_print=split(rs("PRINT_ID"),",")
		for j=0 to ubound(a_print)%>
		<a href="http://kes1-barcode:8888/Store/PrintStoreRepeatList.asp?printid=<%=a_print(j)%>" target="_blank"><%=a_print(j)%></a><br>
		<%next
		end if%>&nbsp;</td>
	  ...
	  <td><div align="center">
		...
		<td><div align="center"><% =rs("ERP_ERROR_CODE")%>&nbsp;</div></td>
...
wend%>
 <tr>
    <td height="20" colspan="14"><div align="center">
