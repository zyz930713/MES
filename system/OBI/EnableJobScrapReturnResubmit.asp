...
cmd.CommandText="KE_OBI_KES1_UTIL.UPDATE_JOB_MASTER_SCRAP_CHG"
cmd.CommandType=4
...
cmd.Parameters.Append cmd.CreateParameter("p_allow_erp_resubmit", adVarChar, adParamInput, 10, "Y")
cmd.execute
set cmd=nothing
word="改变提交状态为有效！"
%>
