...
var strSearchErrorType="Error Type|出错类型" 
var arrSearchErrorType=strSearchErrorType.split("|")
var strSearchErrorTypeSelect="-- Select Type --|-- 选择类型 --" 
var arrSearchErrorTypeSelect=strSearchErrorTypeSelect.split("|")
var strSearchErrorTypeStartError="Start Error|起始数量超出" 
var arrSearchErrorTypeStartError=strSearchErrorTypeStartError.split("|")
var strSearchErrorTypeExceedError="Exceed Error|入库数量超出" 
var arrSearchErrorTypeExceedError=strSearchErrorTypeExceedError.split("|")
...
var strStartTime="Start Time|开始生产时间" 
...
try{inner_SearchErrorType.innerText=arrSearchErrorType[<%=session("language")%>]}catch(e){}
try{document.all.errortype.options[0].text=arrSearchErrorTypeSelect[<%=session("language")%>]}catch(e){}
try{document.all.errortype.options[1].text=arrSearchErrorTypeStartError[<%=session("language")%>]}catch(e){}
try{document.all.errortype.options[2].text=arrSearchErrorTypeExceedError[<%=session("language")%>]}catch(e){}
