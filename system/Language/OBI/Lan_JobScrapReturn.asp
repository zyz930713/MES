...
var strBrowse="Browse Job Auto (Scrap Change)|浏览工单自动报废变更" 
...
var strOldScrapQuantity="Old Store Quantity|旧的入库数量" 
var arrOldScrapQuantity=strOldScrapQuantity.split("|")
var strNewScrapQuantity="New Store Quantity|新的入库数量" 
