...
htmls="<html><head><meta http-equiv='Content-Type' content='text/html ; charset=gb2312'>"
...
htmls=htmls&"<td colspan='2'><span style='height:40px;line-height:40px;font-size:24px;'><b>Overdate un-returened product reminding - Beijing</b></span></td>"
...
set rsjs2 = server.createobject("adodb.recordset")
SQL = "select SNNO, BOXNO, SENDAREA, OPERATORCODE, GETCODE, ACCEPTCODE, PTCSTATE,TXTCOMMENTS, AREA, EXPECTDATE, SENDDATE from PTC_SN where EXPECTDATE is not NULL and SYSDATE > EXPECTDATE and SELECTTYPE <> '不归还' and PTCSTATE <> '已归还' and PTCSTATE <> '结束'"
'response.write(SQL)

rsjs1.Open SQL,conn

htmls=htmls&"<table name='content' id='content' width='100%' border='1' cellpadding='5' cellspacing='0' bgcolor='#7BB1DB' >"
	...
	htmls=htmls&"<td>"&rsjs1("SENDDATE")&"</td>"
	htmls=htmls&"</tr>"
...
if MailSwitch > 0 then
	select case MailSwitch
			...
			case 2
				mailto="linlin.hao@knowles.com;henry.qi@knowles.com;fanny.zhang@knowles.com;xinjiang.wu@knowles.com;Alian.Wang@knowles.com;Young.Li@knowles.com;"
			case 3
				'mailto="_KEB_BPS_PTC@knowles.com"
				mailto="linlin.hao@knowles.com;henry.qi@knowles.com;fanny.zhang@knowles.com;xinjiang.wu@knowles.com;Alian.Wang@knowles.com;Young.Li@knowles.com;tim.wang@knowles.com;jie.qin@knowles.com;Fred.Yuan@knowles.com;Gerald.Li@knowles.com"
			case else
