	...
	<table width="800" border="1" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="center">
				...
				　Machine：
				<select name="MaName" id="TmLine" ></select>
	...
	<table width="800" border="1" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="5" align="center">
				<%if session("ShiftEditRole") = "0" then%><input type="button" value="Set Target" onClick="window.location.reload('SetHvPeriphery.asp');" />　　　　<%end if%>
