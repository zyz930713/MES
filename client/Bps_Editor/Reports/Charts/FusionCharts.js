...
infosoftglobal.FusionCharts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	if(swf) { this.setAttribute('swf', swf+'?nb=INFOSOFTGLOBAL.COM'); }
