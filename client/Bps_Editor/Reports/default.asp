...
<div id="menu">
	<ul id="webmenu" class="first-menu">
	  ...
	  <li><a href="###" class="arrow" target="_self">待增加</a></li>
	</ul>
</div>
<div id="content1">
	<iframe src="http://10.6.100.57:9810/bpseditor/reports/DailyReportHv.asp" id="main" name="main" marginheight="0" frameborder="0" scrolling="no" vspace="0" hspace="0" marginwidth="0" width="100%" onLoad="iFrameHeight()">
	</iframe>
...
<div id="footer"><p>© KEB Production System (BPS)</p></div>
</body>
</html>
