...
<script type="text/javascript">
	...
	function inputBoxId(objValue){
		if(event.keyCode==13){
			...
			var data = window.showModalDialog("WarehouseOut1.asp?"+r,window,"dialogHeight:10px;dialogWidth:10px;alwaysLowered:yes");
...
<table id="table1" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    <thead>
      <tr>
        <td colspan="4" align="center" class="incent">WH Out 确认出库</td>
      </tr>
      <tr >
