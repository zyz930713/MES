...
<script type="text/javascript">
	...
	function inputBoxId(objValue){
		if(event.keyCode==13 && objValue!=""){
			...
			document.getElementById("txt_RMANO").disabled=false;		
			var r=$("#form1").formSerialize()+"&asynid=4";				
			var data = window.showModalDialog("RMA1.asp?"+r,window,"dialogHeight:100px;dialogWidth:100px;alwaysLowered:yes");
			...
			document.getElementById("txt_RMANO").disabled=true;	
	...
	function doSplit(){		
		...
		var data = window.showModalDialog("RMA1.asp?"+r,window,"dialogHeight:10px;dialogWidth:10px;alwaysLowered:yes");
		var result=$.parseJSON(data);
		var result=$.parseJSON(data);
				if(result.error==undefined){
...
<table id="table1" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    <thead>
      <tr>
        <td colspan="4" class="t-t-DarkBlue" align="center">RMA 客退处理</td>
      </tr>
      <tr >
	...
	<tfoot>	
      <tr>
        <td colspan="4" align="center" ><br>		
			<input name="btnSplit" type="button" id="btnSplit" onClick="doSplit()" value="RMA 处理">			
			&nbsp;
