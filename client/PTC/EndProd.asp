...
<script language="javascript"  type="text/javascript">
	...
	function SaveData()
	{
		...
		if(!document.form1.SNNO.value){
			...
			document.form1.action="EndProd2.asp";
...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <form id="form1" method="post" name="form1">  	
    <tr>
      <td height="20" colspan="2" class="t-t-DarkBlue"  align="center">(NPI接收)</td>
    </tr>
    ...
    <tr>
      <td > Number 单号</td>
      <td ><input name="SNNO" type="text" id="BoxNo" size="50" value=<%=SNNO%> ></td>
    </tr>
	<tr>
      <td >借出方</td>
