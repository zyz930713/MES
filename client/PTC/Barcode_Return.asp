...
<input name="btnclose" type="button"  id="btnclose"  value="继续扫描 " onClick="javascript:window.location.reload();">	  <input name="btnSubmit" type="button" id="btnSubmit"  value="部分归还" onClick="RSaveData();">
...
<input name="btnSubmit2" type="button" id="btnSubmit2"  value="全部归还" onClick="rAllSaveData();">
<%else%>
<input name="btnclose" type="button"  id="btnclose"  value="确认全部归还 " onClick="javascript:window.location.reload();">
