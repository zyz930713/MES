...
<script language="javascript"  type="text/javascript">
	...
	function SaveData()
	{
	 	...
	 	if(document.form1.computername.value=="")
		{
		 ...
		 if(!document.form1.operatorcode.value){
			alert("Operator Code cannot be blank!\n工号不能为空！");
			document.form1.operatorcode.focus();
			return false;
		}		
...
<body onLoad="form1.operatorcode.focus();" bgcolor="#339966">

<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
  <form id="form1" method="post" name="form1">  	
    <tr>
      <td height="20" colspan="2" class="t-t-DarkBlue"  align="center">OQC</td>
    </tr>
	...
	<tr>
      ...
      <td ><input name="operatorcode" type="text" id="operatorcode" value=<%=OperatorCode%> ></td>
    </tr>
