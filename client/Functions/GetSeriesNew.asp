<%
function getSeriesNew(showstyle,series,where,order,splitchar)
...
SQLS="Select S.NID,S.SERIES_NAME from SERIES_NEW S inner join FACTORY F on S.FACTORY_ID=F.NID "&where&order
