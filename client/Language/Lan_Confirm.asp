...
var strTitle="NCMR Ticket ( Verification ) |异常处理单记录单 （结果确认） "
var arrTitle=strTitle.split("|")
var strTitle1="NCMR Ticket ( Final Review ) |异常处理单记录单 （最终确认） "
var arrTitle1=strTitle1.split("|")
...
var strPerson8 ="Person|负责人" 
var arrPerson8=strPerson8.split("|")
var strPerson9 ="Person|负责人" 
var arrPerson9=strPerson9.split("|")
...
var strRecords6="None Records|没有记录"
var arrRecords6=strRecords6.split("|")
var strRecords7="None Records|没有记录"
var arrRecords7=strRecords7.split("|")
...
var strDepartment2="Department|责任部门" 
var arrDepartment2=strDepartment2.split("|")
var strOperator="Action Person|本次处理人" 
var arrOperator=strOperator.split("|")
...
var strDueDate2="Due Date|指定完成日期" 
...
var strRepeat1="Is Repeat|是否重复"
var arrRepeat1=strRepeat1.split("|")
var strRepeatAlert="If it had repeat, please input NCMR NO.|(如若重复，请填写重复的NCMR单号)"
var arrRepeatAlert=strRepeatAlert.split("|")

var strTrkPerson="Tracking Person|QA追踪人"
var arrTrkPerson=strTrkPerson.split("|")
var strTrkNote="Tracking Note|追踪说明"
var arrTrkNote=strTrkNote.split("|")
var strTrkDate="Tracking Date|追踪日期"
var arrTrkDate=strTrkDate.split("|")
var strRepeat="Is Repeat|是否重复"
var arrRepeat=strRepeat.split("|")

var strReview="Final Review|最终确认"
...
try{inner_Title1.innerText=arrTitle1[<%=session("language")%>]}catch(e){} 
...
try{inner_Person8.innerText=arrPerson8[<%=session("language")%>]}catch(e){} 
try{inner_Person9.innerText=arrPerson9[<%=session("language")%>]}catch(e){} 
try{inner_Station.innerText=arrStation[<%=session("language")%>]}catch(e){}
...
try{inner_Department2.innerText=arrDepartment2[<%=session("language")%>]}catch(e){}
try{inner_Operator.innerText=arrOperator[<%=session("language")%>]}catch(e){}
...
try{inner_Records7.innerText=arrRecords7[<%=session("language")%>]}catch(e){}
...
try{inner_Repeat1.innerText=arrRepeat1[<%=session("language")%>]}catch(e){}
...
try{inner_TrkPerson.innerText=arrTrkPerson[<%=session("language")%>]}catch(e){} 
try{inner_TrkNote.innerText=arrTrkNote[<%=session("language")%>]}catch(e){} 
try{inner_TrkDate.innerText=arrTrkDate[<%=session("language")%>]}catch(e){} 
try{inner_Review.innerText=arrReview[<%=session("language")%>]}catch(e){} 
