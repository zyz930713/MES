...
%>
<form name="form1" method="post" action="CarrierLoop.asp" >
...
categoriesXml = ""
datasetXml = ""
	Sql = "EXEC dbo.GetCarrierFORLoop @productName = N'"&productName&"',@LineName = N'"&LineName&"',@StartTime = N'"&Sdatetime&"',@EndTime = N'"&Edatetime&"',@CarrierID = "&C&""
	'response.write Sql
