...
<script type="text/javascript">
	...
	function inputBoxId(objValue){
		if(event.keyCode==13 && objValue!=""){
			...
			var data = window.showModalDialog("Split_BOXALL1.asp?"+r,window,"dialogHeight:100px;dialogWidth:100px;alwaysLowered:yes");
	...
	function doSplit(){		
		...
		var data = window.showModalDialog("Split_BOXALL1.asp?"+r,window,"dialogHeight:10px;dialogWidth:10px;alwaysLowered:yes");
		var result=$.parseJSON(data);
		var result=$.parseJSON(data);
				if(result.error==undefined){
