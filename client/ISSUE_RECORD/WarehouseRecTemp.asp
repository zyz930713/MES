...
<script type="text/javascript">
	...
	function inputBoxId(objValue){
		if(event.keyCode==13){
			...
			var data = window.showModalDialog("WarehouseRecTemp1.asp?"+r,window,"dialogHeight:10px;dialogWidth:10px;alwaysLowered:yes");
    ...
    <thead>
	 ...
	 <tr>
	  ...
	  <tr >
       ...
       <tr >
        <td align="right">产品总数</td>
        <td><input name="Sum_unitqty" type="text" id="Sum_unitqty" style='background-color:#666666' value="0" size="17"  readonly='true'/></td>
	  </tr>
	  <tr align="center">
