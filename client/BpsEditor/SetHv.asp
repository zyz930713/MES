...
if TargetSet = "新增" or TargetSet = "修改" then
	...
	if TargetSet = "修改" then
		...
		call sussLoctionHref("修改成功","SetHv.asp?SearchTarget=ok&ProductName="&ProductName&"&LineName="&LineName&"&AYear="&AYear)
	end if
end if
%>
<center>
<form name="SetHv" method="post" action="SetHv.asp" >
		<table width="800" border="1" cellspacing="0" cellpadding="0">
			<tr style="height:30px;line-height:30px;">
				...
				　年：<input type="text" name="AYear" value="<%=AYear%>" size="6"/>
...
<tr style="height:30px;line-height:30px;">
	<th>项目</th><th>线号</th><th>Target日期</th><th>Output</th><th>Transfer</th><th>CELL 1</th><th>CELL 2</th><th>CELL 3</th><%if ProductName = "RA" or ProductName = "Slim" then%><th>CELL 4</th><th>CELL 5</th><%end if%><th>OEE</th><th>操作</th>
</tr>
	...
	<tr>
		<td colspan="5" align="center">
			<%if session("ShiftEditRole") = "0" then%>
				<input type="button" value="设置外围Target" onClick="window.location.reload('SetHvPeriphery.asp');" />　　　　
			<%end if%>
