...
<!--#include virtual="/WOCF/TSDconn1.asp" -->
...
sqlV=sqlV+" select *, ROW_NUMBER() over(PARTITION by [SERIAL_NUMBER] order by test_time desc) rn from  [TEST_RESULT_DETAIL_S]   where  TEST_NAME   in ( 'Micro-THDgap')  and  SERIAL_NUMBER='"&Dcode&"')"
sqlV=sqlV+"  temp where rn=1"
...
<td ><span class="STYLE9"><%=rsTSD("summary_id")%></span></td>
...
<td align="center" class="STYLE9"><%=rsTSD("TEST_ENVIRONMENT")%></td>
