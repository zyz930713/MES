...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperationTSDNEWFG1.asp",r,function(data,textStatus){
			//alert(data);
			var result=$.parseJSON(data);
			if(result.error==undefined){
				alert(result.message.replace("|","\n"));
				window.location="PackingOperationRWKFG1.asp"; 
				$("#btnReset").click();	
				$("table tbody").html("");
				AddRows();
	...
	function Print(){
		...
		$.ajax({
			type: "post",
			url: "PackingOperationTSDNEWFG1.asp",
			async:false,
			data:r,
  ...
  <table id="table1" width="800px" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    <thead>
	  ...
	  <tr >
        ...
        <td><input name="txt_supplier" type="text" id="txt_supplier"  style="background-color:#666666" size="40" readonly="true" /></td>
	  </tr>
	   <tr >
