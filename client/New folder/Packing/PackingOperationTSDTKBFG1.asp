...
function checkTestResult(str2DCode,strPartNumber)
	...
	strSql="select test_name,alarm_msg from part_test_name where part_number = '"&strPartNumber&"' and test_type='TKB' and test_name  in('"&replace(testNameQ,",","','")&"') "
   ...
   if alarmMsg="" then
    ...
    strSql="select test_name,alarm_msg from part_test_name where part_number = '"&strPartNumber&"' and test_type='TKB'"
    rs.open strSql,conn,1,3
	...
	strSql="select test_name,alarm_msg from part_test_name where part_number = '"&strPartNumber&"' and test_type='TKB'and test_name not in('"&replace(testName,",","','")&"') "
