	...
	select case asynid
		...
		case "2" 'print
			...
			if errMsg="" then				
				...
				sql=sql+",PALLET_ID,SHIPPED_USER,SHIPPED_TIME,CUSTOMER_LABEL_ID,PACKED_LINE,PROD_SHIFT,SUPPLIER,PLAN_ID,STACK_USER,STACK_TIME,DELIVERY_ID,WHREC_USER,WHREC_TIME,GET_USER,GET_TIME)"
				...
				sql=sql+"SHIPPED_TIME,CUSTOMER_LABEL_ID,PACKED_LINE,PROD_SHIFT,SUPPLIER,PLAN_ID,STACK_USER,STACK_TIME,DELIVERY_ID,WHREC_USER,WHREC_TIME,GET_USER,GET_TIME FROM JOB_PACK_DETAIL "
				sql=sql+" WHERE BOX_ID IN ('"&boxIdList&"')"
				rs.open sql,conn,1,1
