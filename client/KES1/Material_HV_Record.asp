...
//		
		var rtnValue = window.showModalDialog("Material_HV_Record2.asp?LabelId="+labelid.value+"&LotNo="+document.all.LotNo.value+"&Update_time="+document.all.Update_time.value+"&EQUIPMENT="+document.all.EQUIPMENT.value,window,"dialogHeight:10px;dialogWidth:10px;alwaysLowered:yes");
