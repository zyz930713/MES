...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperationTSDWeekMarigold1.asp",r,function(data,textStatus){
			//alert(data);
			var result=$.parseJSON(data);
			if(result.error==undefined){
				alert(result.message.replace("|","\n"));
				window.location="PackingOperationTSDWeekMarigold.asp"; 
				$("#btnReset").click();	
				$("table tbody").html("");
				AddRows();
				document.getElementById("unitTestInfo").src="TSDTestDataMarigold.asp";	
			}
			else{
	...
	function Print(){
		...
		$.ajax({
			type: "post",
			url: "PackingOperationTSDWeekMarigold1.asp",
			async:false,
			data:r,
...
function istrue(str){ 
		...
		document.getElementById("unitTestInfo").src="TSDTestDataMarigold.asp?txt_2d_code="+name;	
...
<input type="hidden" id="txt_pack_type" value="<%=packType%>" />
  ...
  <center>
  <iframe src="TSDTestDataMarigold.asp" width="95%" height="320" scrolling="auto" frameborder="0" id="unitTestInfo"></iframe>
  </center>
