...
<form name="form2" method="post" action="KEB_TSD.asp?PRODUCT=<%=request("PRODUCT")%>">
...
response.End()
		...
		sql="select * from Vw_Packing where serialnumber ='"&Dcode&"'" 
		else 
...
<td ><span class="STYLE9"><%=rsTSD("resultID")%></span></td>
