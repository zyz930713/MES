...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperation3.asp",r,function(data,textStatus){
			//alert(data);
...
'elseif rsAsyn("SN") ="2200" then

'    word="<span align='center' style='color:red;'>"&txt_boxid&"此箱已包满！</span>"
'	response.Redirect("PackingOperationNPI.asp?word="&word)
  ...
  <table id="table1" width="800px" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    <thead>
      ...
      <tr >
        ...
        <td><input type="text" id="txt_opcode" size="22" name="txt_opcode"    value="<%=session("UserCode")%>" readonly="readonly"  style="background-color:#666666"/></td>
