...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperationScrap1.asp",r,function(data,textStatus){
			//alert(data);
			var result=$.parseJSON(data);
			if(result.error==undefined){
				alert(result.message.replace("|","\n"));
				window.location="PackingOperationScrap.asp";
				$("#btnReset").click();	
				$("table tbody").html("");
				AddRows();
	...
	function Print(){
		...
		$.ajax({
			type: "post",
			url: "PackingOperationScrap1.asp",
			async:false,
			data:r,
  ...
  <table id="table1" width="800px" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000099" bordercolordark="#FFFFFF">
    <thead>
      ...
      <tr >
        ...
        <td><input type="text" id="txt_customer" name="txt_customer" value="<%=request("txt_customer")%>" /></td>		        
      </tr>
      <tr >
        ...
        <td><input type="text" id="txt_remarks" name="txt_remarks" style="background-color:#666666" readonly="readonly" value="<%=Remarks%>" /></td>
      </tr>
	  <tr  >
	  ...
	  <tr >
	   ...
	   <tr >
        ...
        <td><input type="text" id="txt_custid" name="txt_custid" style="background-color:#666666" readonly="true" /></td>
	   </tr>
	    <tr>
