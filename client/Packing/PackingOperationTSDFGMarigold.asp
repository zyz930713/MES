...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperationTSDFGMarigold1.asp",r,function(data,textStatus){
			//alert(data);
			var result=$.parseJSON(data);
			if(result.error==undefined){
				alert(result.message.replace("|","\n"));
				window.location="PackingOperationTSDFGMarigold.asp"; 
				$("#btnReset").click();	
				$("table tbody").html("");
				AddRows();
	...
	function Print(){
		...
		$.ajax({
			type: "post",
			url: "PackingOperationTSDFGMarigold1.asp",
			async:false,
			data:r,
