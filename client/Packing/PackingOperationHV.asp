...
<script type="text/javascript">
	...
	function Save(){
		...
		$.post("PackingOperationHV1.asp",r,function(data,textStatus){
			//alert(data);
			var result=$.parseJSON(data);
			if(result.error==undefined){
				alert(result.message.replace("|","\n"));
				window.location="PackingOperationHV.asp"; 
				$("#btnReset").click();	
				$("table tbody").html("");
				AddRows();
    ...
    <thead>
	  ...
	  <tr >
	   ...
	   <tr >
        ...
        <input name="txt_custid" type="text" id="txt_custid" style="background-color:#666666"  value="<%=CUSTOMER_LABEL_ID%>" size="22"/>
        <%else%>
